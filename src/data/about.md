...
Graduated in CSE from the School of Data and Sciences at BRAC University. Currently a forward-looking Software Engineer with experience in developing Full-Stack projects with MERN and Django Framework. Well-versed in Test-Driven Development, Software Development Lifecycle and System Design. Last but not least, Python is my native and love to solve problems using it, also proficient in Java and JavaScript.
...
Remember that the one laughs the last, laughs the best :')
